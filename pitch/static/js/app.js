...
Application.prototype.start = function () {
    ...
    window.onload = () => {
        document.getElementById('recordButton').addEventListener('click', (element) => {
            let item = document.getElementById('recordButton')
            let recording = item.classList.contains('recording')
