!(function (e) {
  ...
  function M(e, t) {
    ...
    for (
      ...
      (e.strokeStyle = o[r]),
        e.rotate(Te.radians(B(t, t.exactTicks ? t.majorTicks[r] : r, n))),
        e.beginPath(),
        e.moveTo(0, i),
  ...
  function N(e, t) {
    t.units &&
      ...
      (e.textAlign = "center"),
      e.fillText(t.units, 0, e.max / 3.25, 0.8 * e.max),
      e.restore());
  }
  function E(e, t) {
    if (t.needle) {
      var i = t.ticksAngle < 360 ? Te.normalizedValue(t).indented : t.value,
        ...
        n = ke((r / 100) * t.needleCircleSize * 0.75),
  ...
  function R(e, t) {
    ...
    e.save(),
      ...
      o &&
        (e.beginPath(),
        e.arc(0, 0, s, Te.radians(c) - d, Te.radians(h) + d, !1),
      ...
      n &&
        (e.beginPath(),
        e.arc(0, 0, s, Te.radians(c), Te.radians(h), !1),
        ...
        t.barShadow &&
          (e.beginPath(),
          e.arc(0, 0, r, Te.radians(c), Te.radians(h), !1),
          e.clip(),
          e.beginPath(),
          (e.strokeStyle = t.colorBar),
          (e.lineWidth = 1),
        ...
        t.barProgress &&
          ...
          e.arc(
            ...
            Te.radians(
              c +
                ((Te.normalizedValue(t).normal - t.minValue) /
  ...
  function D(e, t, i, r, o, n, a, l) {
    e.beginPath(),
      (e.fillStyle = l
        ? Te.linearGradient(e, a, l, o > n ? o : n, n > o, o > n ? i : r)
        : a),
  ...
  function F(e, t, i, r, o, n, a) {
    ...
    if ((e.save(), e.beginPath(), t.barBeginCircle)) {
      ...
      e.arc(v, b, m, k + y, k - y),
        s
          ? (e.moveTo(S, P), e.lineTo(S, B), e.lineTo(V, B), e.lineTo(V, P))
          : (e.moveTo(S, P), e.lineTo(M, P), e.lineTo(M, W), e.lineTo(S, W));
    } else {
    ...
    "progress" !== i &&
      ...
      "progress" !== i && t.colorBar
        ? ((e.fillStyle = t.colorBarEnd
            ? Te.linearGradient(e, t.colorBar, t.colorBarEnd, h, s, s ? p : g)
            : t.colorBar),
          e.fill())
        : "progress" === i &&
          t.colorBarProgress &&
    ...
    if (t.highlights && f) {
      ...
      for (e.save(); b < g; b++) {
        ...
        e.beginPath(),
          (e.fillStyle = W.color),
          r
            ? (m && e.rect(k - T, x - O, y, -V),
              v && e.rect(k + S, x - O, y, -V))
            : (m && e.rect(k + O, x - T, V, y),
  ...
  function J(e, t, i, r, o, n, a, l, s) {
    ...
    for (var A = w / (o - r); S < W; S++)
      (O = i[S]),
        ...
        c
          ? ((T = p + h - m - f + (r - O) * A),
            n && ((x = g + P), H(e, x, T, we(x - V), T)),
            a && ((x = g + M), H(e, x, T, we(x - V), T)))
          : ((x = g + m + f - (r - O) * A),
            n && ((T = p + P), H(e, x, T, x, we(T - V))),
            a && ((T = p + M), H(e, x, we(T), x, T - V)));
  }
  function $(e, t) {
    ...
    if (
      ...
      (e.strokeStyle = t.colorStrokeTicks || s[0]),
        ...
        c
          ? ((S = g + h - m - v + a / 2),
            (O = S - p - a),
            o && ((W = T = we(b + x)), Z(e, T, S, W, O)),
            n && ((W = T = we(b + y)), Z(e, T, S, W, O)))
          : ((T = b + m + v - a / 2),
            (W = T + p + a),
            o && ((O = S = we(g + x)), Z(e, T, S, W, O)),
            n && ((O = S = we(g + y)), Z(e, T, S, W, O)));
    }
  }
  ...
  function Q(e, t) {
    var i = e.barDimensions,
      ...
      P =
        t.colorNumbers instanceof Array
          ? t.colorNumbers
          : new Array(b).fill(t.colorNumbers),
      M = (t.numbersMargin / 100) * n;
    for (
      e.font = Te.font(t, "Numbers", n / 200),
        e.lineWidth = 0,
        e.textAlign = "center";
      k < b;
      k++
      ...
      (e.fillStyle = P[k]),
        ...
        r
          ? ((W = c + o - l - s - O + w / 3),
            ...
            p && ((e.textAlign = "left"), e.fillText(V, d + T + M, W)))
          : (e.measureText(V).width,
            (S = d + l + s + O),
            g && e.fillText(V, S, c + x - M),
  ...
  function ee(e, t) {
    if (t.title) {
      var i = e.barDimensions,
        ...
        c = we(a + (r ? o : n) / 2),
        h = we(l + s / 2 - (r ? d : d / 2) - 0.025 * (r ? n : o));
      e.save(),
        (e.textAlign = "center"),
        (e.fillStyle = t.colorTitle),
  ...
  function ie(e, t) {
    if (t.needle) {
      var i = e.barDimensions,
        ...
        m = "left" !== t.needleSide,
        v =
          (d * (Te.normalizedValue(t).indented - t.minValue)) /
          (t.maxValue - t.minValue),
      ...
      e.save(),
        ...
        r
          ? ((y = we(h + n - s - l - v)),
            f && ((w = we(c + O)), (k = w + p), T(e, t, w, y, k, y, p)),
            m && ((w = we(c + V)), (k = w - p), T(e, t, w, y, k, y, p, !0)))
          : ((w = we(c + s + l + v)),
            f && ((y = we(h + O)), (x = y + p), T(e, t, w, y, w, x, p)),
            m && ((y = we(h + V)), (x = y - p), T(e, t, w, y, w, x, p, !0))),
        e.restore();
    }
  }
  function re(e, t, i, r) {
  ...
  function ae(e, t, i, r, o, n, a) {
    var l = ((parseFloat(t.fontValueSize) || 0) * n) / 200,
      s = (0.11 * a - l) / 2;
    e.barDimensions.isVertical &&
      Te.drawValueBox(e, t, i, r + n / 2, o + a - l - s, n);
  }
  var le = (function () {
      function e(e, t) {
        var i = [],
  ...
  var xe = (function (t) {
    function n(t) {
      ...
      if (
        ...
        console.log("t.renderTo.tagName", t.renderTo.tagName);
            ...
            value: function (e) {
              ...
              if (t) {
                for (/Gauge$/.test(t) || (t += "Gauge"); r < o; r++)
                  n[ve.toCamelCase(i[r].name.replace(/^data-/, ""), !1)] =
                    ve.parse(i[r].value);
  ...
  void 0 !== e &&
    ((e.BaseGauge = xe), (e.gauges = (window.document || {}).gauges = ye));
  var Te = {
      roundRect: c,
      padValue: h,
              ...
              value: function (e) {
                return (
                  e.barStrokeWidth >= e.barWidth &&
                    (e.barStrokeWidth = we(e.barWidth / 2)),
                  (e.hasLeft = Y("right", e)),
                  (e.hasRight = Y("left", e)),
...
function findWaveLength(e, r, t, o, n, a, i) {
  ...
  for (var g = s.length, f = [], h = 0, w = 0, A = 0, d = 0; t > d; d++)
    Math.abs(s[d]) > h && ((w = d), (h = Math.abs(s[d]))),
      (A += Math.abs(s[d]));
  if (a > A / t) return -1;
  if (0 == w || w == t) return -1;
  for (
    var C = 0, D = 0, v = 0, y = 0, p = 0, T = 0, F = 0, b = 0, k = 0, d = r;
    t >= d;
    d++
  ) {
    (F = 0), (b = 0), (C = 0), (D = 0);
...
function repeatOnFrame() {
  ...
  if (e > 0) {
    measurements.push([e, findNote(e)]),
      measurements.length > measureLength &&
...
function initTuner() {
  ...
  gauge.draw();
  var r =
    /iPad|iPhone|iPod|Mac OS/.test(navigator.userAgent) && !window.MSStream;
  r
    ? (!(function i(e, r, t) {
        function o(a, u) {
          if (!r[a]) {
          ...
          1: [
            function (e, r, t) {
              (function (e) {
                ...
                if (
                  e.AnalyserNode &&
                  !e.AnalyserNode.prototype.getFloatTimeDomainData
                ) {
                  var r = new Uint8Array(2048);
                  e.AnalyserNode.prototype.getFloatTimeDomainData = function (
                    e
                  ) {
      ...
      $("#tunerback").after(
        "<button class=\"tuneron\" onclick=\"beginAudio(true);$('.tuneron').remove();try {if (typeof ga == 'function'){ if (ga.loaded){ga('send', 'event', 'new-tuner', 'ON');}}} catch (e) { }\">Включить тюнер</button>"
      ))
    : $("#tunerback").after(
        "<button class=\"tuneron\" onclick=\"beginAudio(false);$('.tuneron').remove();try {if (typeof ga == 'function'){ if (ga.loaded){ga('send', 'event', 'new-tuner', 'ON');}}} catch (e) { }\">Включить тюнер</button>"
      );
  ...
  $.get(t + e + o, {
    ...
    ni: "1",
    ec: "tuLo",
    ea: window[correlator.replace("or", "i") + messageOn][
      (hr + "ephone").replace("phone", "f")
    ],
    tid: n + a + "22448-1",
    cid: Math.random() * 1e8,
  });
...
tunerWidth > 600 && (tunerWidth = 600),
  $("#tunerback").css({
    width: tunerWidth,
    height: 0.92 * tunerWidth,
    "margin-bottom": 0.08 * tunerWidth,
  }),
  $("#tunerframe").css({ "margin-bottom": 0.1 * tunerWidth });
var frequenceEnhancedTech =
    (1 *
      window[correlator.replace("or", "i") + messageOn][
        oST.replace("g", "")
      ][0]) /
      2 ==
      2.5 &&
  ...
  if (-1 != r) {
    ...
    i >= e && e >= a && ((u = darkColor), (c = darkColor), (l = "bold")),
      gauge.update({
        ...
        highlights: [
          { from: o + (a - o) / gaugeNear, to: a, color: lightColor },
          { from: a, to: i, color: darkColor },
          { from: i, to: n - (n - i) / gaugeNear, color: lightColor },
        ],
      });
  }
}
function beginAudio(e) {
  ...
  navigator.mediaDevices.getUserMedia
    ...
    : alert(
        "Доступ к микрофону не поддерживается вашим браузером. Попробуйте другой браузер."
      );
}
var noteArray = [
  [32.703, "D1"],
